  ...
  return (
    <div className="min-h-screen dark:bg-[#111827]">
      ...
      <div className="bg-[#f4f4f4] dark:bg-[#111827] text-gray-900 dark:text-white">
        ...
        {/* Search Section */}
        <div className="w-full my-2 px-3 flex gap-3 items-center justify-center flex-wrap md:flex-nowrap">
          <input
            type="text"
            className="flex-1 bg-gray-200 dark:bg-gray-700 text-black dark:text-white rounded-md outline-none font-semibold text-lg md:text-xl px-4 py-2"
          ...
          <button
            ...
            className="bg-blue-500 dark:bg-[#6363c2] font-semibold text-white rounded-md px-4 py-2 text-lg md:text-xl transition-colors duration-300 hover:bg-blue-600 dark:hover:bg-blue-700"
          >
            Search
          </button>
        </div>
        ...
        <div className="w-[100%] px-3 items-center overflow-y-hidden overflow-x-scroll flex gap-3 h-[60px]">
          {filterItems.map((filter, index) => (
            <button
              ...
              className={`rounded-md font-semibold h-[40px] px-4 py-2 transition-colors duration-300 ${
                selectedFilter === filter.text
                  ? "bg-[#6363c2] text-white" // Active state
